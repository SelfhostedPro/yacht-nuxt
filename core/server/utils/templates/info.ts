import { yachtTemplateSchema, type PortainerV1Template, type PortainerV2Template, type YachtTemplate, type YachtV1Template } from "#core/types/templates/yacht";
import { typeTemplate, getTemplateType } from "./formatter";
import fs from 'fs-extra'
import { configPaths } from "#config/server/utils/config";
import {
    parseJSONC,
    parseYAML,
    parseTOML,
